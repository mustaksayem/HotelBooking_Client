const Footer = () => {
    return (
      ...
      <footer className="bg-white dark:bg-gray-900 border border-t-4 border-blue-500">
    <div className="container p-6 mx-auto ">
        <div className="lg:flex">
            <div className="w-full -mx-6 lg:w-2/5">
                <div className="px-6">
                    ...
                    <p className="max-w-sm mt-2 text-gray-500 text-2xl font-bold dark:text-gray-400">RoomRover</p>
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">roomrover@email.com</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <p className="text-center text-gray-500 dark:text-gray-400">©mustakhasansayem - All rights reserved</p>
        </div>
    </div>
</footer>
    )
